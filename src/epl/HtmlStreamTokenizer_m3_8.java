...
package com.tasktop.internal.hp.qc.core.model.comments.mylyn3_8;
...
/**
 * Forked version of the Mylyn 3.8 HtmlStreamTokenizer. Kept for allowing old comment html cleaning to still work.
 * 
 ...
 * @since 3.7
 */
public class HtmlStreamTokenizer_m3_8 {
	 ...
	 */
	private Token_m3_8 pushbackToken;
	 ...
	 */
	public HtmlStreamTokenizer_m3_8(Reader in, URL base) {
	 ...
	 */
	public void pushback(Token_m3_8 token_m3_8) {
		pushbackToken = token_m3_8;
	}
	...
	/**
	 * parses HTML tag attributes from a buffer and sets them in an HtmlTag_m3_8
	 */
	private static void parseAttributes(HtmlTag_m3_8 tag, String s, int i, boolean escapeValues) throws ParseException {
		while (i < s.length()) {
			// skip whitespace
	 ...
	 */
	public static class Token_m3_8 {
		 ...
		 */
		protected Token_m3_8(HtmlTag_m3_8 tag, StringBuffer whitespace) {
			type = TAG;
			value = tag;
		 ...
		 */
		protected Token_m3_8(StringBuffer text, StringBuffer whitespace, boolean comment) {
			if (comment) {
				type = COMMENT;
			} else {
				type = TEXT;
		...
		/**
		 * Returns the token's value. This is an HtmlTag_m3_8 for tokens of type <code>TAG</code> and a StringBuffer for
		...
		public String toString() {
			...
			if (value != null) {
				...
				sb.append(value);
				if (type == TAG) {
					// if(value instanceof HtmlTag_m3_8) {
					// HtmlTag_m3_8 HtmlTag_m3_8 = (HtmlTag_m3_8)value;
					// if(HtmlTag_m3_8.getTagName().startsWith("?xml")) {
					// sb.append("?>");
					// }
					// } else {
					// sb.append('>');
